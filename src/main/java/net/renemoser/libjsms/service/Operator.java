...
public abstract class Operator {
     ...
     */
    protected int matchAvailableMessages(String pattern) throws IOException, NumberFormatException {
     ...
     */
    protected StringBuffer buildRequest(Hashtable<String, String> parameters) throws UnsupportedEncodingException {
